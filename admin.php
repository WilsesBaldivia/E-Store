...
$dashboardLowStock = array_values(array_filter($inventory, static fn(array $item): bool => ((int) $item['stock_quantity'] - (int) $item['reserved_quantity']) <= (int) $item['reorder_level']));
